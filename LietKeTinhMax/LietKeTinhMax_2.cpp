...
void lietKeTime(int iNgay)
{
	...
	for(j=3; ((iNgay + j <= MAX_DAY)&&(j<=40)); j++) 
	{
		...
		//if((iNgay >  80)&&(fGiaTriHienTai <  22000000.0)) break;	//4844667.0		5/5/2009
		//if((iNgay > 160)&&(fGiaTriHienTai < 220000000.0)) break;	//40171132.0	8/25/2009
				
		if((iNgay >  50)&&(fGiaTriHienTai <   2858490.5)) break;	//	3/19/2009
		if((iNgay > 100)&&(fGiaTriHienTai <   6809778.0)) break;	//	6/2/2009
		if((iNgay > 150)&&(fGiaTriHienTai <  58758008.0)) break;	//	8/11/2009
		if((iNgay > 200)&&(fGiaTriHienTai < 325320064.0)) break;	//	10/21/2009
		...
		if((iNgay + j + 3 > MAX_DAY)&&(fGiaTriHienTai > 200000000.0)) capNhatKiLuc();
		else if (iNgay + j + 3 <= MAX_DAY) lietKeTime(iNgay + j + 3);
